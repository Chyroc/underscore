...
import (
	"errors"
	"github.com/Chyroc/underscore/utils/tmplutil"
	"os"
	"strings"
)
...
func generateStackFactory(schema string) func(pkg, typ, output string) error {
	...
	return func(pkg, typ, output string) error {
		...
		bs, err := tmplutil.ParseTmpl(tmpl, map[string]interface{}{
			"pkg":        pkg,
...
var stackTmpl = `// Code generated by underscore_generate. DO NOT EDIT.
